         ...
         <section className="relative z-10 flex items-center gap-5 px-5 sm:justify-center">
            <div className="flex flex-col items-center justify-center text-secondary/50 sm:flex-row sm:gap-16 lg:gap-28">
               ...
               <div className="flex flex-col items-center">
                  ...
                  <div className="flex items-center gap-3 lg:text-3xl">
                     <svg
                        width="18"
                        height="15"
                        viewBox="0 0 18 15"
               ...
               <div className="mt-4 h-[1px] w-[120px] bg-[#00559E] shadow-lg sm:mt-0 sm:h-[50px] sm:w-[1px] lg:h-[80px]"></div>

               {/* usuarios */}
               <div className="flex flex-col items-center">
                  <h1 className="pt-5 text-2xl font-bold text-[#F7A932] sm:pt-0 lg:text-5xl">
                     +80M
                  </h1>
                  <div className="flex items-center gap-1 lg:text-3xl">
                     <svg
                        width="19"
                        height="16"
                        viewBox="0 0 19 16"
