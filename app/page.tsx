...
export default function Home() {
   return (
      <div className="text-primary">
         ...
         {/* dashboard image */}
         <section className="relative z-10 flex items-center gap-5 px-5">
            <div className="flex flex-col items-center text-secondary/50">
               ...
               {/* usuarios */}
               <h1 className="pt-5 text-2xl font-bold text-[#F7A932]">+80M</h1>
               ...
               {/* Lojas */}
               <h1 className="pt-5 text-2xl font-bold text-[#F7A932]">+180k</h1>
